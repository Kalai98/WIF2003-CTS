...
function saveToLocalStorage(id){
    ...
    if(id == 'a31' || id == 'a32'){
        if(localStorage.getItem('a31') && localStorage.getItem('a32')){
    ...
    if(id == 'a91' || id == 'a92'){
        if(localStorage.getItem('a91') && localStorage.getItem('a92')){
            localStorage.setItem('a9', true);
        }else{
            localStorage.setItem('a9', false);
        }
    }
    if(id == 'a81' || id == 'a82' || id == 'a83' || id == 'a84' || id == 'a85'){
        if(localStorage.getItem('a81') && localStorage.getItem('a82') && localStorage.getItem('a83') && localStorage.getItem('a84') && localStorage.getItem('a85')){
